...
def read_poses_data():
    ...
    with open("proto_python/poses_data.yaml") as poses_data:
                    ...
                    MocapExchange_pb2.Joint(
                        ...
                        transform=MocapExchange_pb2.Transform(
                            ...
                            orientation=MocapExchange_pb2.Orientation(
                                rotationType=MocapExchange_pb2.Orientation.RotationType.Value(
                                    joint_from_file["transform"]["orientation"][
                                        "rotationType"
                                    ]
                                ),
                                rotationValues=joint_from_file["transform"][
                                    "orientation"
                                ]["rotationValues"],
                            ),
                        ),
        ...
        response = MocapExchange_pb2.MocapStreamResponse(
            poses=poses_list, serverTime=10
        )
                ...
                links=[
                    MocapExchange_pb2.Link(
                        ...
                        offset=MocapExchange_pb2.Transform(
                            ...
                            orientation=MocapExchange_pb2.Orientation(
                                rotationType=MocapExchange_pb2.Orientation.RotationType.Value(
                                    link_from_file["offset"]["orientation"][
                                        "rotationType"
                                    ]
                                ),
                                rotationValues=link_from_file["offset"]["orientation"][
                                    "rotationValues"
                                ],
                            ),
                        ),
                        ...
                        linkSize=[
                            size_from_file
                            for size_from_file in link_from_file["linkSize"]
                        ],
                        inertialMatrix=[
                            inertialMatrix_from_file
                            for inertialMatrix_from_file in link_from_file[
                                "inertialMatrix"
                            ]
                        ],
                    )
